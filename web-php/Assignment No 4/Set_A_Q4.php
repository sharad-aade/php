...
if(method_exists($ob,'f4')) //returns true if the method f4 exists for the object ob
{
echo "method f4 exists";
}
var_dump(get_object_vars($ob)); //returns an array of parameter / variables for given object
?>